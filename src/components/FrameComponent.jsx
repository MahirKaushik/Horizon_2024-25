...
const FrameComponent = ({ className = "" }) => {
  return (
    ...
    >
      ...
      >
        <div className="self-stretch flex flex-row items-start justify-start py-[0px] pl-[0px] lg:pl-[16px] pr-[2px] lg:pr-[20px] box-border max-w-full">
          <h2 className="lg:m-[0px] lg:h-[72px] w-[226px] flex-1 relative text-inherit tracking-[0.03em] uppercase font-normal font-[inherit] flex items-center justify-center max-w-full mq450:text-[36px] mq767:text-[48px]">
            ABOUT US
          </h2>
        </div>
        <div className="self-stretch h-[704px] lg:h-[440px] relative text-[32px] tracking-[-0.01em] font-['Open_Sans'] text-justify flex items-center mq450:text-[19px] mq767:text-[26px]">
