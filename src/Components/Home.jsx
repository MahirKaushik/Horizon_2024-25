            ...
            <div>
                <div className="hidden lg:block h-screen w-full overflow-hidden">
                    <div className="h-1/3 w-full bg-[#fefbec] flex justify-center items-center">
                        <p className="font-main text-[16vw]">HORIZON'24</p>
                    </div>
                ...
                <div className="lg:hidden h-screen w-full overflow-hidden">
                    ...
                    <div className="w-full bg-[#b5ddc2] items-center h-5/6 border-t-black border-b-black border-2">
                        <div className="w-full h-full border-black relative">
                            <div className="h-[25vh] m-[4vw]">
                                <br /> <br />
                                <span className="text-[2.5vh] font-poppins font-thin">One of the Biggest Technical</span><br />
                                <span className="block my-2 text-[2.5vh] font-poppins font-thin">Fests in India <span className="font-extrabold">is back in 2024</span></span><br />
                                <span className="text-[2.5vh] font-poppins font-thin block">Sed vestibulum diam auctor, </span>
                                <span className="text-[2.5vh] mb-4 font-poppins font-thin ">tincidunt <span className="font-extrabold">mi nec</span></span><br />
                            </div>
                            <div className="h-2/3 ">
                                <div className="w-full  flex justify-center relative">
                                    <img className="h-[35vh] w-[80vw] mt-8 mb-3" src="/homepage.png" />
                                </div>
